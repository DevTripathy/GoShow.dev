...
const ResetPassword = () => {
  ...
  return (
    ...
    {!isEmailSent && 
      ...
      <form className="w-full max-w-md mx-auto bg-black/10 backdrop-blur-md rounded-2xl shadow-2xl p-8 border-3 border-primary">
        ...
        <button className='w-full py-2.5 rounded-full font-medium bg-primary-dull/90 text-white cursor-pointer hover:-translate-y-0.5  hover:bg-primary transition-all duration-300'>Submit</button>
