...
import { LayoutDashboardIcon, ListCollapseIcon, PlusSquareIcon, ListIcon, User } from 'lucide-react'
...
const AdminSidebar = () => {
  ...
  return (
    <div className='h-[calc(100vh-64px)] md:flex flex-col items-center pt-8 max-w-13 md:max-w-60 w-full border-r border-gray-300/20 text-sm'>
      ...
      <p className='mt-2 text-base max-md:hidden'>{adminData ? adminData.name : user.firstname}</p>
